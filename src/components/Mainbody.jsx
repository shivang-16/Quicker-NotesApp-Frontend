                ...
                notes.map((element) => {
                  ...
                  return (
                    <div className="note-card" key={_id}>
                      ...
                      <button
                        className="icon card-btn delete-btn"
                        onClick={() => handleDelete(_id)}
                      >
                        <img src={recycle} alt="Logo" />
                      </button>
                      <button
                        className="icon card-btn edit-btn"
                ...
                <div className="addNoteBox">
                  <form onSubmit={handleEditSubmit}>
                    ...
                    <div>
                      ...
                      <button className="login-btn" onClick={handleCancelEdit}>
                        Cancel
                      </button>
                    </div>
                  </form>
